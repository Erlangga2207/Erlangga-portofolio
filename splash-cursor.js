/* ── SPLASH CURSOR — Fluid WebGL Simulation ────
   Ported from React Bits SplashCursor component
   to vanilla JS for use without a framework.
─────────────────────────────────────────────── */
(function initSplashCursor() {
  ...
  // Skip on mobile — two concurrent WebGL contexts (aurora + fluid) tanks mobile GPU
  if (isMobile) return;
